...
contract EchidnaTester {
    ...
    constructor() public payable {
       ...
       // TODO: User a proper ERC20 Mock to represent collateral token
    ...
    function echidna_ETH_balances() public view returns(bool) {
        ...
        if (address(activePool).balance != activePool.getERC20TokenBalance()) {
            return false;
        }

        if (address(defaultPool).balance != defaultPool.getERC20TokenBalance()) {
            return false;
        }
